...
async function loadGameData() {
  try {
    ...
    logMessage('🌱 Bem-vindo à Fazenda! Cuide da soja e do Bulba!');
...
function updateBulbasaurMood() {
  ...
  if (disease > 70 || pest > 70) {
    moodText = '😰 Bulba está muito preocupado com a lavoura!';
    moodClass = 'stressed';
  } else if (nutrition < 30) {
    moodText = '😟 Bulba sente que a lavoura precisa de nutrientes...';
    moodClass = 'worried';
  } else if (energy < 20) {
    moodText = '😴 Bulba está exausto, precisa descansar!';
    moodClass = 'worried';
  } else if (mood < 30) {
    moodText = '😢 Bulba está triste... que tal brincar um pouco?';
    moodClass = 'worried';
  } else if (mood >= 80 && trust >= 70 && nutrition >= 70) {
    moodText = '🌟 Bulba está radiante! A fazenda vai bem!';
    moodClass = 'happy';
  } else if (mood >= 60) {
    moodText = '😊 Bulba está feliz e confiante!';
    moodClass = 'happy';
  } else {
    moodText = '🙂 Bulba está observando a lavoura atentamente.';
    moodClass = '';
  }
...
function feedBulbasaur() {
  ...
  updateUI();
  logMessage('🍎 Você alimentou o Bulba! Energia restaurada.');
}
...
function playWithBulbasaur() {
  ...
  updateUI();
  logMessage('🎮 Você brincou com o Bulba! Ele está mais feliz e confiante.');
}
...
function inspectCrop() {
  ...
  logMessage('🔍 Bulba inspecionou a lavoura...');
